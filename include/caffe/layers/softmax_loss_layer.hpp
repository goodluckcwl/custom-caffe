...
class SoftmaxWithLossLayer : public LossLayer<Dtype> {
 ...
 protected:
  ...
  /// Indicating whether soft prob is used or not
  bool is_soft_classify_;
  // Indicating whether the second top blob is softmax prob or landmark loss.
  bool is_output_landmark_loss_;
  float hard_ratio_;
  ...
  Blob<Dtype> counts_;
  Blob<Dtype> loss_;
  // The groundtruth generate
  Blob<Dtype> prob_groundtruth_;
  // Indicate the size of the region for cross entropy
  int roi_;
  // The std of the gaussion kernel
  Dtype gaussion_sigma_;
  // For profile landmark detection
  bool is_profile_;
  int profile_type_;
  std::vector<int> cur_profile_type_;


  //
  SoftmaxWithLossParameter_KernelType type_;
